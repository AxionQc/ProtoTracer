...
private:
    ...
    uint8_t faceCount    = 10; ///< Total number of faces available (e.g., for UI or animations).
     Vector2D BonkSize = Vector2D(110, 110);
     Vector2D BonkOffset = Vector2D(100, 50);
...
protected:
    ...
    Material* GetBackgroundMaterial();
     ...
     BonkSequence bonksequence = BonkSequence(BonkSize, BonkOffset, 8.0f);
public:
    /**
